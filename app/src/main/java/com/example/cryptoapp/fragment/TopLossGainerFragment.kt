...
import com.example.cryptoapp.databinding.FragmentTopLossGainerBinding
...
class TopLossGainerFragment : Fragment() {


    lateinit var binding: FragmentTopLossGainerBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTopLossGainerBinding.inflate(layoutInflater)
